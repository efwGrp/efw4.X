...
public final class DatabaseManager {
	...
	/**
	 * デフォルトのデータベースインスタンスを取得する。
	 * @return デフォルトのデータベースインスタンス。
	 */
    public static Database getDatabase(){
    	return framework.getDatabase(framework.getJdbcResourceName());
    }
    /**
     * JDBCリソースで指定データベースインスタンスを取得する。
     * @param jdbcResourceName JDBCリソース。
     * @return 指定データベースインスタンス。
     */
	...
	/**
	 * WEBで起動時、フレームワークに利用するデータソースを初期化する。
	...
	/**
	 * バッチで起動時、フレームワークに利用するデータソースを初期化する。
	 */
