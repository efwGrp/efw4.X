...
public final class Sql {
	 ...
	 * @param key　指定キー。
	 * @return　判断結果。
	 * @throws efwException スクリプトエラー。
	 */
	protected static boolean isTrue(Map<String,Object> params,String script) throws efwException{
		return ScriptManager.getBool(params, script);
	}
	/**
	 * パラメータマップに指定キーのパラメータが空白か否か判断する。
	 * 指定キーのパラメータが存在しない場合、true。
