		...
		if(this.authCases!=null&&!this.authCases.equals("")){
			...
			for(int i=0;i<ary.length;i++){
				...
				if(!ary[i].equals("")){
					...
					String uploadable=PropertiesManager.getProperty(authCaseKey+"."+PropertiesManager.EFW_AUTH_UPLOADABLE,"");
					if(!authPattern.equals("")&&!urlPattern.equals("")){
						...
						data.put(PropertiesManager.EFW_AUTH_UPLOADABLE, uploadable);
