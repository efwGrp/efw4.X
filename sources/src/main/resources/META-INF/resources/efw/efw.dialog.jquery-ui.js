...
var EfwDialog = function() {
	...
	//--progress------------------------------------------------------------
	$("body").append("<div id='efw_client_progress' style='display:none'><p></p><progress style='width:100%' max='100' value='0'></progress></div>");
	this._progress = $("#efw_client_progress").dialog({
		modal : true,
		width : 500,
		title : "Progress",
		autoOpen: false
