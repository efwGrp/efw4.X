...
elfinder_cmds.fire = function(params) {
	try{
		var cmd=params["cmd"];
		     if(cmd=="archive"){return event.fire("elfinder_archive", params);}//zip files
		...
		else if(cmd=="open"){return event.fire("elfinder_open", params);}//open directory and initializes data when no directory is defined (first iteration)
