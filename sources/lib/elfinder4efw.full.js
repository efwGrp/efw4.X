...
var elFinder = function(node, opts) {
	...
	*/
	 ...
	 * @return String
	 */
	this.decodeRawString = (typeof this.options.rawStringDecoder === 'function')? this.options.rawStringDecoder : function(str) {
...
elFinder.prototype = {
	...
	kinds : 	{
			...
			'application/vnd.oasis.opendocument.base'                  : 'OO',
			...
			'image/x-portable-pixmap'       : 'PXM',
			'audio/mpeg'                    : 'AudioMPEG',
			'audio/midi'                    : 'AudioMIDI',
			'audio/ogg'                     : 'AudioOGG',
			'audio/mp4'                     : 'AudioMPEG4',
			'audio/mp4'                     : 'AudioMPEG4',
			'audio/vnd.wave'                : 'AudioWAV',
			'audio/x-mpegurl'               : 'AudioPlaylist',
