...
public final class PropertiesManager {
	...
	/**
	 * 権限チェック個別ケースのアップロード可否。
	 * 「####.uploadable」の定数。
	 */
	public static final String EFW_AUTH_UPLOADABLE  ="uploadable";
	/**
	 * システムエラー遷移画面のURL。
	...
	/**
	 * Scriptエンジン
	 * 「efw.script.engine」の定数。
	 */
	public static final String SCRIPT_ENGINE="efw.script.engine";
